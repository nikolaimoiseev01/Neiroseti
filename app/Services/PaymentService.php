...
use App\Services\CallbackPaymentServices\FullAccessPaymentService;
...
class PaymentService
{
        ...
        return DB::transaction(function () use ($amount, $urlRedirect, $transactionData) {
            ...
            $payment = $client->createPayment([
                ...
                'metadata' => [
                    ...
                    'transaction_data' => json_encode($transactionData['data'] ?? null),
                ],
                'capture' => true,
    ...
    public function callbackPayment($yooKassaObject): void
    {
        ...
        if ($metadata['transaction_type'] == TransactionTypeEnums::FULL_ACCESS->value) {
            (new FullAccessPaymentService($yooKassaObject))->update();
        }
    }
}
