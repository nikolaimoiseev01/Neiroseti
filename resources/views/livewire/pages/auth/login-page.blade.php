...
>
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="p-8 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">
            ...
            @if ($errors->any())
                <div class="my-4 p-4 rounded-xl bg-red-500/10 border border-red-500/30 text-sm text-red-300">
                    <ul class="px-4 py-0 mt-0">
            ...
            <form @submit.prevent="submit()" class="space-y-5">
                ...
                >
                    <span wire:loading.remove x-text="isLogin ? 'Войти' : 'Создать аккаунт'"></span>
                    <svg
                        wire:loading
